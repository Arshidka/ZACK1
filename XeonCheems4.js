...
│
└─「📍 𝘽𝙊𝙏 𝙄𝙉𝙁𝙊 📍」       
│𒈒𝗦𝗽𝗲𝗲𝗱 : ${latensie.toFixed(4)} miliseconds
│𒈒𝗥𝘂𝗻𝘁𝗶𝗺𝗲 : ${runtime(process.uptime())}
│𒈒𝗕𝗼𝘁 𝗡𝗮𝗺𝗲 : ${global.botname}
│𒈒𝗢𝘄𝗻𝗲𝗿 𝗡𝗮𝗺𝗲 : ${global.ownername}
│𒈒𝗢𝘄𝗻𝗲𝗿 𝗡𝗼. : ${global.owner}
│𒈒𝗛𝗼𝘀𝘁 𝗡𝗮𝗺𝗲 : ${os.hostname()}
│𒈒𝗣𝗹𝗮𝘁𝗳𝗼𝗿𝗺 : ${os.platform()}
│𒈒𝗧𝗼𝘁𝗮𝗹 𝗨𝘀𝗲𝗿 : ${Object.keys(global.db.data.users).length}
│𒈒𝗧𝗼𝘁𝗮𝗹 𝗛𝗶𝘁 : ${jumlahcmd}
│𒈒𝗧𝗼𝘁𝗮𝗹 𝗛𝗶𝘁 𝗧𝗼𝗱𝗮𝘆 : ${jumlahharian}
└┬────────────┈ 𒈒
   │✑  Please Select
   │✑  The Button Below
   └─────────────┈ 𒈒`
